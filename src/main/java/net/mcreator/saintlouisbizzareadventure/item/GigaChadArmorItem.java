...
public class GigaChadArmorItem extends SaintLouisBizzareAdventureModElements.ModElement {
	@ObjectHolder("saint_louis_bizzare_adventure_:giga_chad_armor_helmet")
	public static final Item helmet = null;
	@ObjectHolder("saint_louis_bizzare_adventure_:giga_chad_armor_chestplate")
	public static final Item body = null;
	@ObjectHolder("saint_louis_bizzare_adventure_:giga_chad_armor_leggings")
	public static final Item legs = null;
	@ObjectHolder("saint_louis_bizzare_adventure_:giga_chad_armor_boots")
