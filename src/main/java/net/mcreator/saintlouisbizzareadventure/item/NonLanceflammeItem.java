...
import net.mcreator.saintlouisbizzareadventure.entity.renderer.NonLanceflammeRenderer;
...
public class NonLanceflammeItem extends SaintLouisBizzareAdventureModElements.ModElement {
	@ObjectHolder("saint_louis_bizzare_adventure_:non_lanceflamme")
	...
	public static class ItemRanged extends Item {
		public ItemRanged() {
			...
			setRegistryName("non_lanceflamme");
		}
		...
		public void onPlayerStoppedUsing(ItemStack itemstack, World world, LivingEntity entityLiving, int timeLeft) {
			if (!world.isRemote && entityLiving instanceof ServerPlayerEntity) {
				...
				if (true) {
					ItemStack stack = ShootableItem.getHeldAmmo(entity, e -> e.getItem() == Items.FLINT_AND_STEEL);
					if (stack == ItemStack.EMPTY) {
						for (int i = 0; i < entity.inventory.mainInventory.size(); i++) {
							ItemStack teststack = entity.inventory.mainInventory.get(i);
							if (teststack != null && teststack.getItem() == Items.FLINT_AND_STEEL) {
								stack = teststack;
								break;
							}
						}
					...
					if (entity.abilities.isCreativeMode || stack != ItemStack.EMPTY) {
						...
						if (entity.abilities.isCreativeMode) {
							...
							if (new ItemStack(Items.FLINT_AND_STEEL).isDamageable()) {
