...
public class SaintLouisBizzareAdventureModElements {
	...
	public SaintLouisBizzareAdventureModElements() {
		...
		sounds.put(new ResourceLocation("saint_louis_bizzare_adventure_", "ahhhhhhhhhhhhhhh"),
				new net.minecraft.util.SoundEvent(new ResourceLocation("saint_louis_bizzare_adventure_", "ahhhhhhhhhhhhhhh")));
		sounds.put(new ResourceLocation("saint_louis_bizzare_adventure_", "transformers"),
				new net.minecraft.util.SoundEvent(new ResourceLocation("saint_louis_bizzare_adventure_", "transformers")));
		sounds.put(new ResourceLocation("saint_louis_bizzare_adventure_", "lbj"),
		...
		sounds.put(new ResourceLocation("saint_louis_bizzare_adventure_", "zozozozoooooooo"),
		...
		try {
			...
			for (ModFileScanData.AnnotationData annotationData : annotations) {
				if (annotationData.getAnnotationType().getClassName().equals(ModElement.Tag.class.getName())) {
					...
					if (clazz.getSuperclass() == SaintLouisBizzareAdventureModElements.ModElement.class)
						elements.add((SaintLouisBizzareAdventureModElements.ModElement) clazz.getConstructor(this.getClass()).newInstance(this));
				}
			}
		} catch (Exception e) {
			e.printStackTrace();
		...
		elements.forEach(SaintLouisBizzareAdventureModElements.ModElement::initElements);
	}
	...
	public <T> void addNetworkMessage(Class<T> messageType, BiConsumer<T, PacketBuffer> encoder, Function<PacketBuffer, T> decoder,
		...
		SaintLouisBizzareAdventureMod.PACKET_HANDLER.registerMessage(messageID, messageType, encoder, decoder, messageConsumer);
		messageID++;
	}
	...
	public static class ModElement implements Comparable<ModElement> {
		...
		protected final SaintLouisBizzareAdventureModElements elements;
		protected final int sortid;

		public ModElement(SaintLouisBizzareAdventureModElements elements, int sortid) {
