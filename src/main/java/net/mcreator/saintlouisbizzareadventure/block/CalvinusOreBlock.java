...
import net.mcreator.saintlouisbizzareadventure.item.CalvinusIngotItem;
...
public class CalvinusOreBlock extends SaintLouisBizzareAdventureModElements.ModElement {
	@ObjectHolder("saint_louis_bizzare_adventure_:calvinus_ore")
	...
	private static class FeatureRegisterHandler {
		...
		public void registerFeature(RegistryEvent.Register<Feature<?>> event) {
			CUSTOM_MATCH = Registry.register(Registry.RULE_TEST, new ResourceLocation("saint_louis_bizzare_adventure_:calvinus_ore_match"),
