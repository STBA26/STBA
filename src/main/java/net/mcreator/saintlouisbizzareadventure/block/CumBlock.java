...
public class CumBlock extends SaintLouisBizzareAdventureModElements.ModElement {
	@ObjectHolder("saint_louis_bizzare_adventure_:cum")
	public static final FlowingFluidBlock block = null;
	@ObjectHolder("saint_louis_bizzare_adventure_:cum_bucket")
	...
	public void initElements() {
		fluidproperties = new ForgeFlowingFluid.Properties(() -> still, () -> flowing,
				FluidAttributes
						.builder(new ResourceLocation("saint_louis_bizzare_adventure_:blocks/bucketofcum"),
		...
		still = (FlowingFluid) new CustomFlowingFluid.Source(fluidproperties).setRegistryName("cum");
		flowing = (FlowingFluid) new CustomFlowingFluid.Flowing(fluidproperties).setRegistryName("cum_flowing");
		elements.blocks
	...
	private static class FeatureRegisterHandler {
		...
		public void registerFeature(RegistryEvent.Register<Feature<?>> event) {
			...
			event.getRegistry().register(feature.setRegistryName("cum_lakes"));
			Registry.register(WorldGenRegistries.CONFIGURED_FEATURE, new ResourceLocation("saint_louis_bizzare_adventure_:cum_lakes"),
					configuredFeature);
		}
	}
